  ...
  <div class="privacy-wrapper">
    <div class="content-privacy">
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта компании PriChina,
        ИП Хуснутдинова Айсылу Рафитовна, ИНН 25301919960.
      </p>
      ...
      <p>
        ...
        почты с доменом product@prichina.info с пометкой «Отказ от
