  ...
  <div class="privacy-wrapper">
    <div class="content-privacy">
      ...
      <p>
        ...
        Оператор может получить о посетителях веб-сайта компании PriChina, ИП
        Хуснутдинов Артур Альбертович, ИНН 165712292191.
      </p>
      ...
      <p>
        ...
        почты с доменом product@prichina.info с пометкой «Отказ от уведомлений о
